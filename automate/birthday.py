...
def getBirthdays(numberOfBirthdays):
    ...
    for i in range(numberOfBirthdays):
        #The year is not considered  as long as all
        #birthdays are from the same year
        startOfYear = datetime.date(2004,1,1)

        #Get a random year into the year:
...
print('''Birthday Paradox, by Al Sweigart
      ...
      (It's actually not a pradox, it's just a surprising result.)
      ''')
...
#Run througl 100,000 simulations:
...
for i in range(100_000):
    #Report on the progress of every 100,000 simulations:
    if i % 100_000 == 0:
